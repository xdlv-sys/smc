...
insert into t_dynamic_conf values(24,'1','weightUnit.1','吨','重量单位1');
insert into t_dynamic_conf values(25,'1','weightUnit.2','千克','重量单位2');

insert into t_dynamic_conf values(26,'1','bulkUnit.1','立方米','体积单位');

insert into t_dynamic_conf values(27,'1','countUnit.1','公斤','计量单位1');
insert into t_dynamic_conf values(28,'1','countUnit.2','千克','计量单位1');
insert into t_dynamic_conf values(29,'1','countUnit.3','袋','计量单位1');
insert into t_dynamic_conf values(30,'1','countUnit.4','立方厘米','计量单位1');
insert into t_dynamic_conf values(31,'1','countUnit.5','滥立方厘米','计量单位1');
insert into t_dynamic_conf values(32,'1','countUnit.6','立方分米','计量单位1');
insert into t_dynamic_conf values(33,'1','countUnit.7','批','计量单位1');
insert into t_dynamic_conf values(34,'1','countUnit.8','个','计量单位1');
insert into t_dynamic_conf values(35,'1','countUnit.9','付','计量单位1');
insert into t_dynamic_conf values(36,'1','countUnit.10','件','计量单位1');
insert into t_dynamic_conf values(37,'1','countUnit.11','克','计量单位1');
insert into t_dynamic_conf values(38,'1','countUnit.12','具','计量单位1');
insert into t_dynamic_conf values(39,'1','countUnit.13','副','计量单位1');
insert into t_dynamic_conf values(40,'1','countUnit.14','组','计量单位1');
insert into t_dynamic_conf values(41,'1','countUnit.15','平方分米','计量单位1');