...
insert into t_mod values(-9904,'新增角色','/user/saveMod',null,null,-99);
insert into t_mod values(-9905,'删除角色','/user/deleteMod',null,null,-99);
insert into t_mod values(-9906,'修改角色','/user/saveMod',null,null,-99);
