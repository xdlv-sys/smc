 ...
 */
@Entity
@Table(name = "t_construction_progress")
public class ConstructionProgress {
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "pk_construction_progress_id")
    @TableGenerator(name = "pk_construction_progress_id", table = "t_primary_key",
    ...
    public boolean equals(Object o) {
        ...
        ConstructionProgress that = (ConstructionProgress) o;
